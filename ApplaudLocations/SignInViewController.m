...
- (id)init
{
    ...
    if (self) {
        ...
        self.password = [self makeTextFieldwithYcoordinate:99 name:@"Password" returnKeyType:UIReturnKeyGo isPassword:YES];
        
        // "Sign In" button
        self.signInButton = [UIButton buttonWithType:UIButtonTypeCustom];
        self.signInButton.backgroundColor = [UIColor grayColor];
        self.signInButton.frame = CGRectMake(10,133,TEXTFIELD_WIDTH,TEXTFIELD_HEIGHT);
