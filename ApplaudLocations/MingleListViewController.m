...
- (void)viewDidLoad
{
    ...
    self.navigationController.toolbar.tintColor = [UIColor colorWithRed:0.8 green:0.8 blue:0.8 alpha:1];
...
- (void)handleThreadsData:(NSData*)data {
    ...
    for ( NSDictionary *threadData in threadsData ) {
        ...
        for ( NSDictionary *dict in threadData[@"posts"] ) {
            ...
            postUser.profilePictureURL = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@",SERVER_URL,userDict[@"profile_picture"]]];
